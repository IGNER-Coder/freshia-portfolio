...
export default function HomePage() {
  return (
    <div className="relative w-full h-screen overflow-hidden">
      {/* Reusable Global Navigation Component */}
      ...
      <div className="relative z-20 h-full flex flex-col pointer-events-none">
        ...
        <motion.div
          ...
          className="pb-12 md:pb-16 px-8 md:px-12 pointer-events-auto"
        >
          <div className="flex items-center justify-start md:justify-end">
            ...
            {/* Button */}
            <Link href="/artworks" className="group inline-flex items-center text-white opacity-90 hover:opacity-100 transition-opacity duration-300 pointer-events-auto cursor-pointer">
              <motion.div

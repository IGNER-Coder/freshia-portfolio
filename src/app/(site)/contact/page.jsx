        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24">
          <div className="lg:col-span-5 flex flex-col justify-between">
              ...
              <div className="space-y-8 font-sans">
                ...
                <div>
                  ...
                  <div className="flex flex-col space-y-3">
                    <a
                      href="https://www.instagram.com/fwnjeri/"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-base text-slate-700 hover:text-teal-700 transition-colors font-light inline-flex items-center gap-2"
                    >
                      Instagram
                    </a>
                    <a
            ...
            <div className="mt-16 w-3/4 md:w-2/3 aspect-[4/3] bg-white p-2 shadow-md rotate-1 hover:rotate-0 transition-transform duration-500">
              <img
                src="https://res.cloudinary.com/doevklqj6/image/upload/IMG_5800_1_zgfeba"

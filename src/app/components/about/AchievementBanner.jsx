export default function AchievementBanner() {
  return (
    <div className="mb-20 -mx-6 md:mx-0">
      <div className="bg-slate-900 text-white px-8 py-6 md:px-12 md:py-8 relative overflow-hidden">
        <div className="relative z-10">
          ...
          <p className="font-sans text-sm md:text-base font-light opacity-80">
            International Participant — Wajukuu Arts Collective, 2022
          </p>
        </div>

    ...
    <section className="max-w-5xl mx-auto mb-32 relative">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-20">
        <div className="md:col-span-4 flex flex-col items-center md:items-start shrink-0 relative">
          <div className="sticky top-24 w-full">
            <motion.div 
              ...
              className="w-full max-w-xs md:max-w-full aspect-[3/4] bg-white p-3 shadow-xl mb-12 mx-auto md:mx-0 -rotate-2 hover:rotate-0 transition-transform duration-700"
            >
            ...
            <div className="space-y-6 text-center md:text-left text-slate-500 font-sans hidden md:block border-l-2 border-teal-700/20 pl-6 ml-4">
              <div>
        ...
        <div className="md:col-span-8 font-sans text-lg md:text-xl text-slate-700 font-light leading-loose md:leading-[2.2] space-y-10">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={fadeUp} className="my-16 py-12 px-8 border-y border-slate-900/10 text-center relative bg-white/40">
          ...
          <motion.p initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={fadeUp}>
            I have had the honor of showcasing my work in esteemed venues, including participation in group exhibitions in different countries including Germany, Kassel at Documenta 15 in 2022, and more recently, at Wajukuu in December 2024 “before our homes goes down”. In March 2025 I participated in the exhibition “image in our heads” at Wajukuu artist collective and open studio that happened at the same venue and at the Royal Danish Embassy 2025. These platforms have provided me with invaluable opportunities to connect with diverse audiences and fellow artists, enriching my understanding and knowledge.
          </motion.p>
          ...
          <motion.p initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={fadeUp}>
            As I continue to evolve as an artist, I remain dedicated to exploring new mediums and concepts, pushing the boundaries of my practice to foster deeper connections and understanding through the transformative power of art.
          </motion.p>

          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeUp} className="pt-12">
            <Link 
              href="/artworks" 
